# Generated by Django 2.2.12 on 2020-09-13 18:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField()),
                ('description', models.TextField()),
                ('src_lang', models.CharField(choices=[('en', 'English'), ('vi', 'Vietnamese')], max_length=2)),
                ('tar_lang', models.CharField(choices=[('en', 'English'), ('vi', 'Vietnamese')], max_length=2)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tm_content', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cat.TMContent')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('src_lang', models.CharField(choices=[('en', 'English'), ('vi', 'Vietnamese')], max_length=2)),
                ('tar_lang', models.CharField(choices=[('en', 'English'), ('vi', 'Vietnamese')], max_length=2)),
                ('translate_service', multiselectfield.db.fields.MultiSelectField(choices=[('gt', 'Google Translate'), ('mm', 'My Memory')], max_length=5)),
                ('glossary', models.ManyToManyField(to='cat.Glossary')),
                ('searchable_translation_memory', models.ManyToManyField(to='cat.TranslationMemory')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('writable_translation_memory', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='project_requests_insert', to='cat.TranslationMemory')),
            ],
            options={
                'unique_together': {('name', 'user')},
            },
